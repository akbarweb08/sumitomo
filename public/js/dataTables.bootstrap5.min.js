...
! function(t) {
	"function" == typeof define && define.amd ? define(["jquery", "datatables.net"],
		...
		return e = e || window, (a = a || ("undefined" != typeof window ? require(
			"jquery") : require("jquery")(e))).fn.dataTable || require(
			"datatables.net")(e, a), t(a, 0, e.document)
	...
	return x.extend(!0, o.defaults, {
		...
		function u(e, a) {
			for (var t, n, r = function(e) {
					e.preventDefault(), x(e.currentTarget).hasClass("disabled") || b.page() ==
						e.data.action || b.page(e.data.action).draw("page")
		...
		n.length ? n.empty() : n = e.html("<ul/>").children("ul").addClass(
			"pagination"), u(n, a), t !== s && e.find("[data-dt-idx=" + t + "]").trigger(
			"focus")
	}, o
});